...
//   if (!videoId) {
//     alert("No video selected for style transfer");
//     return;
//   }
...
//     const response = await fetch(`http://localhost:8000/api/transform/${videoId}`, {
//       method: 'POST',
//       headers: {
...
//     // Update state with transformed video
//     setTransformedVideoUrl(data.skeleton_video_url || data.video_url);
    
//     alert(`✓ Style transfer completed successfully!\nTransformed from ${detectedStyle} to ${targetStyle}`);
    
//     // Optionally scroll to video or update UI
//     // scrollToTransformedVideo();
          ...
          <div className="music-recommendations">
            ...
            <div className="music-list">
              ...
              <div className="music-item">
                <h4>4. AI Motion Transfer</h4>
                <p className="description">
                  Our advanced AI extracts poses, transforms the style, and generates a skeleton video.
                </p>
              </div>
            </div>
          </div>
